...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.chefs.update',$chef->id) }}" class="form" method="POST" enctype="multipart/form-data" >
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name" placeholder="example" value="{{ old('name') ?? $chef->name}}">
